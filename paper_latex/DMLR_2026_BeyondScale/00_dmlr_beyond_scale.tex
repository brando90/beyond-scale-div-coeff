...
%  TMLR submission (under review): https://openreview.net/forum?id=3ndFgcqAic  (submitted 2026-07-22, submission #10746)
%
%  Organized structure:
...
% Running headers
\ShortHeadings{Beyond Scale: The Diversity Coefficient}{Miranda, Lee, Sundar, Obbad, Casasola, Schaeffer \& Koyejo}
...
\author{%
  ...
  \texttt{\{brando9, alylee15, sjsundar, eobbad, allyc, rschaef, sanmi\}@stanford.edu}
}
...
% \bibliographystyle set by dmlr2e.sty (plainnat); do not repeat it here — a second \bibstyle in the .aux is a bibtex error
