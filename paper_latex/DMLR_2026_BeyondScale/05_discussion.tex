...
Second, none of four downstream accuracy benchmarks---ARC-Easy, HellaSwag, WinoGrande, and LAMBADA---shows a statistically significant correlation with diversity across the 27 evaluated models (all $p>0.4$; Appendix~\ref{appendix:downstream_benchmarks}).
