...
On MMLU, the average accuracy across model families follows the diversity ranking---USPTO (0.232), PubMed (0.234), USPTO+PubMed (0.235)---though these differences are small and close to the 0.25 chance floor, so we treat this ordering as suggestive rather than conclusive (see Appendix~\ref{appendix:downstream_benchmarks} for why accuracy benchmarks carry little signal at this scale).
