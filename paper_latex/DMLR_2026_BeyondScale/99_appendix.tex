...
A complementary methodological explanation is that accuracy \emph{discretizes} the model's continuous per-choice log-likelihoods through an argmax, and this discretization is known to destroy the smooth capability signal that log-likelihood-based metrics retain at small scale \citep{schaeffer2024elusive}; our cross-entropy evaluation is precisely such a continuous metric.
